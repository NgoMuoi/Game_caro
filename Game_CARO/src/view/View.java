...
public class View implements EventHandler<ActionEvent> {
	...
	private void menu(BorderPane pane) {
		...
		AnchorPane.setTopAnchor(btnAbout, 130.0);
		...
		AnchorPane.setTopAnchor(btnExit, 170.0);
	...
	public void aboutUs() {
		...
		alert.setHeaderText("Game được lập trình bởi các sinh viên:");
		alert.setContentText("1. Ngô Văn Mười \n2. Đặng Văn Duy\n3. Bùi Nhật Khang \n Chúc các bạn chơi game vui vẻ !");
		alert.showAndWait();
	}
	// xet xem ai di truoc
